...
export async function POST(
  ...
  try {
    ...
    // Allow API callers to specify the author (e.g. agent name), fall back to auth user
    const author = result.data.author || auth.user.display_name || auth.user.username || 'system';
